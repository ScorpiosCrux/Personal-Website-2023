	...
	return (
		<ProjectTimeline>
			<div className="projectHeader">
				...
				<p>
					My server is an example of who I am. It is one of my most important ongoing projects. I constantly try,
					learn and correct concepts and ideas with my server as you will see in the following:
				</p>
			...
			<TimelineSection>
				...
				<div className="description">
					<p>
						When COVID-19 started, I decided to build a server to experiment with Linux and Deployment. I wanted
						a place where I could show people my work! A dedicated server!
					</p>
			...
			<TimelineSection>
				...
				<div className="description">
					<p>
						About 1 year later, I thought hosting at home was a flop. I recently discovered Google Cloud Platform
						and found Digital Ocean to be a cheaper alternative. Moved NextCloud to Digital Ocean for $26, now I
						was able to access my files from inside and outside my network with encryption!
					</p>
				</div>
				<TechList>
					<li>Digital Ocean</li>
			...
			<TimelineSection>
				...
				<div className="description">
					...
					<p>
						...
						experimentation. Used Docker Compose to deploy GitLab CE and Docker to deploy GitLab runners on the
						main server.
					</p>

					<p>
						During the summer, I experienced some sudden shutdowns due to lighting, and thus to prevent sudden
						dataloss from brownouts or blackouts, I added a 1500VA battery backup to both servers!
					</p>
